...
architecture STRUCTURE of kria_starter_kit is
  ...
  signal prescaler_0_output : STD_LOGIC;
  ...
  attribute X_INTERFACE_INFO of rpi_16 : signal is "xilinx.com:signal:reset:1.0 RST.RPI_16 RST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of rpi_16 : signal is "XIL_INTERFACENAME RST.RPI_16, INSERT_VIP 0, POLARITY ACTIVE_HIGH";
...
ila_0: component kria_starter_kit_ila_0_0
     port map (
      ...
      probe0(0) => reset_0_1,
      probe1(0) => som240_1_connector_hpa_clk0p_clk_1,
      probe2(0) => clk_wiz_0_clk_out1,
      probe3(0) => prescaler_0_output
    );
prescaler_0: component kria_starter_kit_prescaler_0_0
     port map (
      data_in => clk_wiz_0_locked,
      data_out => prescaler_0_output,
      reset => reset_0_1
    );
