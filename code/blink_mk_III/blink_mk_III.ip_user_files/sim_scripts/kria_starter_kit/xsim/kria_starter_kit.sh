...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xlslice_v1_0_4 -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L zynq_ultra_ps_e_vip_v1_0_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot kria_starter_kit xil_defaultlib.kria_starter_kit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim kria_starter_kit -key {Behavioral:sim_1:Functional:kria_starter_kit} -tclbatch cmd.tcl -protoinst "protoinst_files/kria_starter_kit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb kria_starter_kit.wdb xsim.dir libdpi.so)
