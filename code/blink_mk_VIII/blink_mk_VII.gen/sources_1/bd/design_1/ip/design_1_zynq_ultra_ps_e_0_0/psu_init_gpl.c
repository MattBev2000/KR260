...
/*##################################################################### */
    ...
    * Selection of TSU clock source. TSU clock is common for all the GEMs 00:
    * TSU clock from PLL 10: TSU clock from PLL 01: TSU clock from MIO[26] 11:
    *  TSU clock from MIO[50] or MIO[51]
    *  PSU_IOU_SLCR_GEM_CLK_CTRL_TSU_CLK_SEL                       3
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180308, 0x00700006U ,0x00700006U)
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CLK_CTRL_OFFSET,
		0x00700006U, 0x00700006U);
/*##################################################################### */
