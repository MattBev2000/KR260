namespace eval ::optrace {
  variable script "/data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.cache/wt [current_project]
  set_property parent.project_path /data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.xpr [current_project]
  set_property ip_output_repo /data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc /data/devel/kria_mb/vivado/blink_mk_VIII/blink_mk_VII.srcs/constrs_1/new/constraint.xdc
