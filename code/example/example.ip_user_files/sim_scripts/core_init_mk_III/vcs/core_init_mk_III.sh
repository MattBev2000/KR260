...
design_libs=(xlslice_v1_0_4 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_17 zynq_ultra_ps_e_vip_v1_0_17)
...
compile()
{
  vlogan -work xlslice_v1_0_4 $vlogan_opts +v2k +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  "../../../../../../doc/core_init_mk_III/ipshared/a97c/hdl/xlslice_v1_0_vl_rfs.v" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  "../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  "../../../../../../doc/core_init_mk_III/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work zynq_ultra_ps_e_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.core_init_mk_III xil_defaultlib.glbl -o core_init_mk_III_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./core_init_mk_III_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/ASUS/iCloudDrive/PhD-kriask/prj/example/example.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key core_init_mk_III_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc core_init_mk_III_simv.daidir vcs_lib c.obj)
