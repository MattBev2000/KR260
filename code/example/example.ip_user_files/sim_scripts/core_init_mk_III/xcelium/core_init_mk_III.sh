...
#
# Script generated by Vivado on Sat Jan 04 14:41:51 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : core_init_mk_III.sh
...
#
# Usage        : core_init_mk_III.sh
#                core_init_mk_III.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                core_init_mk_III.sh [-reset_run]
#                core_init_mk_III.sh [-reset_log]
#                core_init_mk_III.sh [-help]
#
...
#                script (type 'core_init_mk_III.sh -help' for more information).
#
...
design_libs_elab="-libname xlslice_v1_0_4 -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname zynq_ultra_ps_e_vip_v1_0_17 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xlslice_v1_0_4 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_17 zynq_ultra_ps_e_vip_v1_0_17)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "core_init_mk_III.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./core_init_mk_III.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xlslice_v1_0_4 $xmvlog_opts +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  "../../../../../../doc/core_init_mk_III/ipshared/a97c/hdl/xlslice_v1_0_vl_rfs.v" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  "../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
  "../../../../../../doc/core_init_mk_III/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work zynq_ultra_ps_e_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../../../doc/core_init_mk_III/ipshared/ec67/hdl" +incdir+"../../../../../../doc/core_init_mk_III/ipshared/a317/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.core_init_mk_III xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.core_init_mk_III -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/ASUS/iCloudDrive/PhD-kriask/prj/example/example.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log core_init_mk_III_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./core_init_mk_III.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: core_init_mk_III.sh [-help]\n\
Usage: core_init_mk_III.sh [-step]\n\
Usage: core_init_mk_III.sh [-lib_map_path]\n\
Usage: core_init_mk_III.sh [-reset_run]\n\
Usage: core_init_mk_III.sh [-reset_log]\n\
Usage: core_init_mk_III.sh [-keep_index]\n\
Usage: core_init_mk_III.sh [-noclean_files]\n\n\
