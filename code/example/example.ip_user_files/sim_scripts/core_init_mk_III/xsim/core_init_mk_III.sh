...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xlslice_v1_0_4 -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L zynq_ultra_ps_e_vip_v1_0_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot core_init_mk_III xil_defaultlib.core_init_mk_III xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim core_init_mk_III -key {Behavioral:sim_1:Functional:core_init_mk_III} -tclbatch cmd.tcl -protoinst "protoinst_files/core_init_mk_III.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb core_init_mk_III.wdb xsim.dir libdpi.so)
