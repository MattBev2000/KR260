...
HD_PWD='C:/Users/ASUS/Documents/PhD/kriask/prj/fan_ex/fan_ex.runs/kria_starter_kit_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_starter_kit_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kria_starter_kit_auto_ds_0.tcl
