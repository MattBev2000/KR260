...
architecture STRUCTURE of kria_starter_kit is
  ...
  component kria_starter_kit_nand_gate_0_0 is
  port (
    a : in STD_LOGIC;
    b : in STD_LOGIC;
    y : out STD_LOGIC
  );
  end component kria_starter_kit_nand_gate_0_0;
...
ila_0: component kria_starter_kit_ila_0_0
     port map (
      ...
      probe0(0) => a_0_1,
      probe1(0) => b_0_1,
      probe2(0) => nand_gate_0_y
    );
nand_gate_0: component kria_starter_kit_nand_gate_0_0
     port map (
      a => a_0_1,
      b => b_0_1,
      y => nand_gate_0_y
